                  ...
                  return (
                    <Link
                      ...
                      className={`inline-flex items-center px-1 pt-1 text-sm font-medium transition-all duration-200 ${
                        isActive
                          ? "text-patriot-blue-600 dark:text-patriot-blue-400 border-b-2 border-patriot-blue-600 dark:border-patriot-blue-400"
                          : "text-gray-500 dark:text-gray-400 hover:text-patriot-blue-600 dark:hover:text-patriot-blue-400 hover:border-b-2 hover:border-patriot-blue-300 dark:hover:border-patriot-blue-600"
                      }`}
                    >
                      {item.name}
                    </Link>
        ...
        <DialogContent className="sm:max-w-[425px] bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="bg-patriot-blue-600 text-white hover:bg-patriot-blue-700 font-medium py-2 px-4 rounded-md w-full flex items-center justify-center"
            >
              <MapPin className="h-4 w-4 mr-2" />
              Change Location
            </button>
            <p className="text-xs text-gray-500 dark:text-gray-400 text-center">
              This will take you to the location setup screen.
            </p>
          </div>
        </DialogContent>
      </Dialog>
