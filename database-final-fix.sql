-- FINAL DATABASE SCHEMA FIX FOR SUPABASE
-- This matches exactly what the API code expects
-- Run this script in your Supabase SQL Editor

-- Step 1: Drop existing tables and functions completely
...
-- Step 5: Create unique constraint for officials (needed for ON CONFLICT)
...
-- Step 8: Create upsert function for officials (matching API expectations)
...
-- Step 9: Create upsert function for counties (matching API expectations)
...
-- Step 10: Insert Pennsylvania officials data with correct state format
